...
# Deferred - only imported when a plot is generated
...
class Bandwidth(avl.Component):
    ...
    async def run_phase(self) -> None:
        ...
        async def counter():
            while True:
                ...
                self.bandwidth[t] += self.item.length
    ...
    async def report_phase(self) -> None:
        ...
        Generate plot of bits shifted over time windows
        ...
        plt.title("JTAG Bandwidth (Bits Shifted over Time)")
        plt.xlabel("Time (ns)")
